...
const STORAGE_KEY$1 = "typeflow-streak";
function loadStreak() {
  try {
...
function diffDays(dateA, dateB) {
  ...
  return Math.round(Math.abs(a - b) / (1e3 * 60 * 60 * 24));
}
function useStreak() {
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-subtle sticky top-0 z-30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: "/",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-label text-muted-foreground hidden sm:block", children: "Calm · Focused · Natural" }),
        streakCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { size: 14, className: "shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tabular-nums", children: streakCount })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-muted/40 border-t border-border py-5 mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 text-center text-muted-foreground text-sm", children: [
      "© ",
...
function getRandomPassage(exclude) {
...
function useLevelProgress() {
  ...
  const [selectedLevelId, setSelectedLevelId] = reactExports.useState(
    progress.currentLevel
  );
  const selectedLevel = levels.find(
    (l) => l.id === selectedLevelId
  );
  const selectLevel = reactExports.useCallback((id) => {
  ...
  const completeLevel = reactExports.useCallback((id, accuracy) => {
...
function HomePage() {
  ...
  const [showLevels, setShowLevels] = reactExports.useState(false);
  const [tempSelectedId, setTempSelectedId] = reactExports.useState(
    (selectedLevel == null ? void 0 : selectedLevel.id) ?? 1
  );
  function openLevelSelector() {
    setTempSelectedId((selectedLevel == null ? void 0 : selectedLevel.id) ?? 1);
    setShowLevels(true);
  }
  function handleStart() {
    selectLevel(tempSelectedId);
    const level = levels.find((l) => l.id === tempSelectedId);
    const passageId = (level == null ? void 0 : level.passageIds[0]) ?? passages[0].id;
    navigate({
      to: "/practice",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      "data-ocid": "home.page",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl mx-auto text-center space-y-8 animate-fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-heading font-display text-foreground", children: [
              "Type ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Naturally" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body max-w-lg mx-auto text-muted-foreground text-base sm:text-lg leading-relaxed", children: "A calm, premium typing practice experience. Real words, real rhythm — no rigid drills, just you and your keyboard." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-2", children: [
            "Real-time WPM",
            "Accuracy tracking",
            "10 Levels",
            "Daily Streak",
            "Dark mode"
          ].map((feat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 bg-card border border-border rounded-xl p-6 sm:p-8 shadow-subtle text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-sm sm:text-base leading-loose text-foreground/80 select-none pointer-events-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: "The ability" }),
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-primary/15 text-primary rounded px-0.5", children: "to focus" }),
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "deeply on a single task is becoming" }),
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-destructive/15 text-destructive rounded px-0.5", children: "incresingly" }),
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "rare in a world of constant distraction…" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-xs text-muted-foreground text-label", children: "✦ live word highlighting preview" })
          ] })
        ] }),
        showLevels && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm",
            "data-ocid": "home.level_selector_overlay",
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl bg-card border border-border rounded-2xl shadow-elevated p-6 sm:p-8 relative animate-fade-in", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground", children: "Choose Your Level" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Select a level to begin your typing session" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        className: [
                          ...
                          unlocked ? isSelected ? "border-primary bg-primary/10 shadow-md" : `border-border ${difficultyBg[level.difficulty]} hover:border-primary/50 cursor-pointer` : "border-border bg-muted/40 cursor-not-allowed opacity-50"
                        ].join(" "),
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] sm:text-xs font-medium mt-1 text-muted-foreground capitalize truncate max-w-full", children: level.label }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mt-5 text-xs text-muted-foreground", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-rose-500 inline-block" }),
                  "Hard"
                ] })
              ] }),
...
function evaluateWord(typed, expected) {
  return typed.trim() === expected ? "correct" : "incorrect";
}
function buildStats(words, startTime, endTime) {
  const elapsedSeconds = Math.max(1, Math.round((endTime - startTime) / 1e3));
  ...
  const mistakes = words.map((w, i) => ({ ...w, index: i })).filter((w) => w.status === "incorrect").map((w) => ({ expected: w.word, typed: w.typed, wordIndex: w.index }));
  return {
...
function useTypingSession(initialPassage) {
  ...
  reactExports.useEffect(() => {
    if (session.phase === "typing" && session.startTime !== null) {
      timerRef.current = setInterval(() => {
        setElapsed(
          Math.round((Date.now() - (session.startTime ?? Date.now())) / 1e3)
        );
      }, 500);
    } else {
  ...
  const liveWpm = reactExports.useCallback(() => {
  ...
  const handleInput = reactExports.useCallback((value) => {
    setSession((prev) => {
      ...
      const startTime = prev.startTime ?? (prev.phase === "idle" ? Date.now() : prev.startTime);
...
function renderInlineTyped(typed, expected) {
  return expected.split("").map((ch, charIdx) => {
    const typedCh = typed[charIdx];
    const key = `char-${charIdx}`;
    if (typedCh === void 0)
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/40", children: ch }, key);
    if (typedCh === ch)
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: ch }, key);
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive underline", children: ch }, key);
  });
}
function WordToken({
  word,
  ...
  const baseClass = "inline-block mr-[0.35em] mb-1 rounded px-0.5 transition-smooth text-base sm:text-lg font-mono leading-relaxed";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `${baseClass} ${colorClass}`, "data-word-key": wordKey, children: [
    word.status === "current" && word.typed ? renderInlineTyped(word.typed, word.word) : word.word,
    isCurrent && word.status === "current" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-0.5 h-4 bg-primary ml-0.5 animate-pulse align-middle" })
  ] });
}
function CompletionPopup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm bg-card border border-border rounded-2xl shadow-elevated p-8 text-center animate-fade-in", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-4", children: passed ? "🎉" : "💪" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl text-foreground mb-1", children: passed ? isLastLevel ? "All Levels Complete!" : `Level ${levelId} Complete!` : `Level ${levelId} Failed` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-6", children: passed ? isLastLevel ? "You've mastered all 10 levels!" : "Great job! Keep going." : "Keep practising — you've got this." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-8 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-primary tabular-nums", children: wpm }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "WPM" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Accuracy" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: isLastLevel && passed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: onTryAgain,
          ...
          passed && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: onNextLevel,
...
function PracticePage() {
  ...
  const passageId = search.passageId;
  const initialPassage = passages.find((p) => p.id === passageId) ?? passages[0];
  ...
  const wordsContainerRef = reactExports.useRef(null);
  const [showPopup, setShowPopup] = reactExports.useState(false);
  const [completionHandled, setCompletionHandled] = reactExports.useState(false);
  reactExports.useEffect(() => {
    var _a2;
  ...
  const wpm = liveWpm();
  const passed = session.stats.accuracy >= ([1, 2, 3].includes(levelId) ? 70 : [4, 5, 6].includes(levelId) ? 75 : 80);
  ...
  function handleNextLevel() {
    ...
    const nextPassageId = (nextLevel == null ? void 0 : nextLevel.passageIds[0]) ?? passages[0].id;
    navigate({
      to: "/practice",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-3xl mx-auto space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold px-2 py-0.5 rounded-full bg-primary/10 text-primary border border-primary/20", children: [
                  "Level ",
                  levelId
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-lg text-foreground truncate", children: passage.title })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground capitalize mt-0.5", children: [
                passage.category,
                " · ",
                passage.difficulty
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4 shrink-0", children: session.phase === "typing" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", "data-ocid": "practice.wpm_display", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-label text-muted-foreground", children: "WPM" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-xl text-primary tabular-nums", children: wpm })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", "data-ocid": "practice.timer_display", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-label text-muted-foreground", children: "Time" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-xl text-foreground tabular-nums", children: formatTime(elapsed) })
              ] })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: session.words.map((word, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      WordToken,
                      {
                        word,
                        wordKey: `word-${i}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 h-1.5 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border-2 border-primary/30 focus-within:border-primary rounded-xl px-5 py-4 transition-smooth shadow-subtle", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-label text-muted-foreground mb-2", children: "Current word" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ref: inputRef,
                ...
                autoComplete: "off",
                spellCheck: false,
                placeholder: session.phase === "idle" ? "Start typing to begin…" : "",
          ...
          session.phase === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-center text-sm text-muted-foreground animate-fade-in",
              "data-ocid": "practice.hint",
              children: "Click the input above and start typing — the timer starts automatically."
            }
          )
        ] }),
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `bg-card border rounded-xl p-5 sm:p-6 text-center shadow-subtle transition-smooth ${accent ? "border-primary/40 ring-1 ring-primary/20" : "border-border"}`,
      children: [
...
function ResultsPage() {
  ...
  const grade = stats.accuracy >= 98 && stats.wpm >= 50 ? "Excellent" : stats.accuracy >= 90 ? "Good" : "Keep practicing";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      className: "flex-1 flex flex-col items-center px-4 sm:px-6 py-10 sm:py-14 animate-fade-in",
      "data-ocid": "results.page",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl mx-auto space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-label text-muted-foreground", children: "Results" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl sm:text-3xl text-foreground", children: passageTitle }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", "data-ocid": "results.stats_grid", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              label: "WPM",
        ...
        stats.mistakes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-card border border-border rounded-xl p-5 sm:p-6 shadow-subtle",
            "data-ocid": "results.mistakes_section",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base mb-4 text-foreground", children: "Mistakes" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-48 overflow-y-auto", children: stats.mistakes.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex items-center justify-between text-sm py-2 border-b border-border last:border-0",
                  "data-ocid": `results.mistake.${i + 1}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-mono", children: "Expected:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-foreground font-semibold", children: m.expected }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-mono", children: "Typed:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-destructive", children: m.typed || "(empty)" })
                  ]
                },
                `mistake-${m.wordIndex}-${m.expected}`
              )) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: () => navigate({
                to: "/practice",
                search: { levelId: 1, passageId: void 0 }
              }),
...
const practiceRoute = createRoute({
  ...
  validateSearch: (search) => ({
    ...
    passageId: typeof search.passageId === "string" ? search.passageId : void 0
  }),
